...
public class LeaveBalance {
    ...
    public LeaveBalance(int balanceId, int empId,
                        int sickLeave, int casualLeave, int earnedLeave) {
    ...
    public void setSickLeave(int s)          { this.sickLeave = s; }
    public int  getCasualLeave()             { return casualLeave; }
    public void setCasualLeave(int c)        { this.casualLeave = c; }
    public int  getEarnedLeave()             { return earnedLeave; }
    public void setEarnedLeave(int e)        { this.earnedLeave = e; }
}