...
public class EmployeeDashboard extends JFrame {
    ...
    private JPanel buildHomePanel() {
        ...
        String shiftText = employee.getShift() != null ? employee.getShift() : "Not Assigned";
    ...
    private JPanel buildShiftCard(String title, String shift, String time, Color accent, String icon) {
        JPanel card = Theme.card();
        card.setLayout(new BorderLayout());
        card.setBorder(new EmptyBorder(20, 20, 20, 20));
        ...
        JLabel shiftLabel = Theme.label(shift, Theme.bold(26), accent);
        JLabel timeLabel = Theme.label("Start: " + time, Theme.plain(11), Theme.TEXT_MUTED);
