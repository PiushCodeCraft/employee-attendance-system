...
public class ViewAttendance extends JPanel {
    ...
    private void initUI() {
        ...
        header.add(Theme.label("Attendance Records", Theme.bold(22), Theme.TEXT_PRIMARY),
                   BorderLayout.WEST);
        ...
        String[] cols = {"Emp ID","Date","Check In","Check Out","Status","Hours","Overtime"};
    ...
    private void loadAll()                  { populate(attService.getAllAttendance()); }
    private void loadByDate(LocalDate date) { populate(attService.getAttendanceByDate(date)); }
