...
public class ReportsPanel extends JPanel {
    ...
    private void initUI() {
        ...
        header.add(Theme.label("Attendance Reports", Theme.bold(22), Theme.TEXT_PRIMARY), BorderLayout.WEST);
        JButton refreshBtn = Theme.button("↻  Refresh", Theme.ACCENT_BLUE);
        ...
        String[] cols = {"Emp ID", "Name", "Total Records", "Present", "Late", "Absent", "Attendance %"};
        ...
        table.getColumnModel().getColumn(6).setCellRenderer(new DefaultTableCellRenderer() {
            @Override public Component getTableCellRendererComponent(JTable t, Object val, boolean sel, boolean foc, int row, int col) {
                ...
                try {
                    ...
                    lbl.setForeground(v >= 90 ? Theme.ACCENT_GREEN : v >= 75 ? Theme.ACCENT_ORANGE : Theme.ACCENT_RED);
    ...
    private void generateReport() {
        ...
        for (Attendance a : all) if (map.containsKey(a.getEmpId())) map.get(a.getEmpId()).add(a);
        ...
        for (Employee e : emps) {
            ...
            double pct   = ea.size() > 0 ? ((present + late) * 100.0 / ea.size()) : 0;
            tableModel.addRow(new Object[]{
                e.getEmpId(), e.getName(), ea.size(), present, late, absent,
