...
public class AdminDashboard extends JFrame {
    ...
    private JPanel buildTopBar() {
        ...
        right.add(Theme.label("● " + LocalDate.now().toString(), Theme.plain(12), Theme.TEXT_MUTED));
    ...
    private JPanel buildHomePanel() {
        ...
        JLabel title = Theme.label("Dashboard Overview", Theme.bold(22), Theme.TEXT_PRIMARY);
        ...
        Object[][] data = attService.getAllAttendance().stream().limit(8).map(a ->
            new Object[]{ a.getEmpId(),
    ...
    private JPanel buildStatCard(String title, String value, Color accent, String icon) {
        ...
        JLabel val = Theme.label(value, Theme.bold(36), accent);
